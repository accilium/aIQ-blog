...
I currently have three screens in front of me with 5-6 sessions with multiple AI agents open in parallel. These agents work on multiple topics - one is summarising energy policy changes, another one works on a storyline for a proposal, the third challenges the structure of a client's AI architecture and so on.

I review what comes back, give feedback and make decisions - every few seconds. After two hours like this I am already feeling a bit depleted, but I still have a fair amount of tokens left in my session window, so we keep going because there is still so much potential for output left in the next three hours.
